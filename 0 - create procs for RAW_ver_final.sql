...
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'íà÷àëè. ïàðàìåòðû: ' + @table  + ', ' + @ps_name  , OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'çàêîí÷èëè', OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'ñîçäàëè òåìïîâóþ òàáëèöó ' + @table_tmp, OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'êîíåö', OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'íà÷àëè. ïàðàìåòðû: ' + @table  + ', ' + @ps_name + ', ' + @ps_colname , OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'íà÷àëè. ïàðàìåòðû: ' + @pf + ', ' 
									       + @ps  + ', '
...
-----
	...
	*/
	...
	begin
		...
		-----
		INSERT INTO log_sublog (log_id, comment, procname)
			VALUES (@log_id, 'ñâè÷íóëè: ' + @sql, OBJECT_NAME(@@procid))
		-----
		--log
		-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'ñâè÷íóëè òàáëèöû' , OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'ìåðäæíóëè: ' + @sql, OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'ñïëèòàíóëè: ' + @sql, OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'ïåðåñòðàèâàåì òåìïîâûå òàáëèöû íà MDWH_RAW_HISTORY', OBJECT_NAME(@@procid))
-----
--log
-----
/*
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'ïåðåñòðîèëè ' , OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'ñîçäàåì êîíñòðåéíòû ' , OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'ñîçäàëè ' , OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'ñâè÷íóëè îáðàòíî â ' + @tbl, OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'íà÷àëè. ïàðàìåòðû: ' + @table_tmp  + ', ' + @ps_TMP  , OBJECT_NAME(@@procid))
-----
--log
-----
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'íà÷àëè. ïàðàìåòðû: ' + @pf + ', ' + @ps , OBJECT_NAME(@@procid))
-----
--log
-----
	...
	-- ñîçäàäèì òåìïîâóþ ôóíêöèþ, äëÿ datetime2 òî÷íîñòü çàõàðäêîäèë â çàâèñèìîñòè îò èìåíè ôóíêöèè
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'ñîçäàëè òåìïîâóþ ôóíêöèþ ' + @pf + '_TMP', OBJECT_NAME(@@procid))
-----
--log
-----


	-- ñîçäàäèì òåìïîâóþ ñõåìó
	SELECT
		@sql =
...
-----
INSERT INTO log_sublog (log_id, comment, procname)
	VALUES (@log_id, 'ñîçäàëè òåìïîâóþ ñõåìó ' + @ps + '_TMP', OBJECT_NAME(@@procid))
-----
--log
-----
